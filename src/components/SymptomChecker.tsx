    ...
    <div className="emergency-card p-8 slide-in">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-indigo-400">Advanced AI Symptom Analysis</h2>
            <p className="text-gray-400 text-sm">
              Powered by 50,000+ medical conditions database with ML-enhanced analysis
            </p>
          </div>
        </div>
        {loading && (
      ...
      <div className="space-y-6">
        <div className="relative">
          ...
          <textarea
            ...
            placeholder="Describe your symptoms in detail... Include onset, duration, severity, and any related factors. Our AI will analyze patterns across 50,000+ conditions. (Press Shift + Enter to analyze)"
            rows={6}
            value={symptoms}
            onChange={(e) => {
            ...
            {analysis.requiresEmergency && (
              <div className="p-6 bg-gradient-to-r from-red-950/50 to-red-900/30 border border-red-800/50 rounded-2xl animate-pulse">
                ...
                <p className="text-red-100 text-lg">
                  Based on our AI analysis, your symptoms require immediate medical attention. 
                  Please call emergency services (911) immediately or seek urgent medical care!
                </p>
              </div>
            )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100 text-base opacity-90 leading-relaxed">
                      While our AI has analyzed your symptoms against our database of 50,000+ conditions,
                      no specific matches were found. This could mean your symptoms are mild or need more
                      detailed description. Please monitor your symptoms carefully and consult a healthcare
                      provider if they persist or worsen.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 p-6 bg-gradient-to-r from-gray-900/80 to-gray-800/50 rounded-2xl border border-gray-700/50">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-semibold text-indigo-400 mb-2">AI-Powered Medical Analysis Disclaimer</h4>
              <p className="text-gray-300 leading-relaxed">
                Our AI system analyzes symptoms against a comprehensive database of 50,000+ medical conditions,
                using advanced pattern recognition and machine learning. However, this analysis is for
                informational purposes only and should not replace professional medical advice, diagnosis,
                or treatment. Always consult qualified healthcare providers for proper evaluation of your
                specific situation.
              </p>
            </div>
          </div>
